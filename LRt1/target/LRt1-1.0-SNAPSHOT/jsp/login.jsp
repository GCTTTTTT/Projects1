...
<body>
  <div class="container">
    ...
    <main>
      ...
      <div class="left">
        <div class="left_container">
          <div class="focus">
            ...
            <!-- 轮播图的图片 -->
            <ul>
              <li><img src="../images/111.png" alt=""></li>
              <li><img src="../images/222.png" alt=""></li>
              <li><img src="../images/333.png" alt=""></li>
            </ul>
            <!-- 小圆点 -->
            <ol class="circle">
            </ol>
      ...
      <!-- 右侧登陆界面 -->
      <div class="right">
        <form action="/LRt1/LoginServlet" method="post" class="login_container">
          <!-- 登录方式 -->
