...
<head>
    ...
    <script>
        window.onload=function (){
            ...
            var ue = UE.getEditor('editor', {autoHeightEnabled: false,toolbars: [
...
// 					});
                        ...
                        for (var i in article_content) {
                            ...
                            if (flag === true) {//可以进行比较了
                                ...
                                if (article_content[i] === tt1[cnt_correct]) {
                                    str_res += article_content[i];
                                } else {
                                    str_res += "<span style='border-bottom:4px double red;'>" + article_content[i] + "</span>";
                                }
...
// 					});
            ...
            //新的下载事件(下载一般用a标签link下载的Servlet，一般不能用ajax直接下载，可以模拟表单？    如果要下载最新的话考虑新加一个刷新下载文件按钮！）
//             $("#submit5").click(function (){
//                 alert("1111");
//
//                 var tt1=UE.getEditor('editor').getContentTxt();
//                 $.ajax({
//                     // url:"http://localhost:8080/LRt1/UploadServlet",
//                     url:"http://192.168.201.134:8080/LRt1/UploadServlet",//注意这里的ip地址可能会变化，现在先写死
//
...
//                 $.ajax({
//                     // url:"http://localhost:8080/LRt1/UploadServlet",
//                     url:"http://192.168.201.134:8080/LRt1/DownloadServlet",//注意这里的ip地址可能会变化，现在先写死
//
//                     // data:String(text=tt1),
//                     type:"GET",
//                     success:function (data) {
            ...
            function handleFiles(files) {
                ...
                if (files.length) {
                    ...
                    reader.onload = function () {
                        ...
                        var array = this.result.replace(/[\n\r]/g, '')//去掉换行
                        // var array = this.result.replace(/[\r]/g, '')//去掉换行
                        // var array=this.result.replace(/[\n\r]/g,'<br/>');//换成<br/>
...
//                                 alert("success!");
                                ...
                                for (var ar in arr) {
                                    // alert(arr[ar][1]+" "+arr[ar][2]);
                                    var tr = document.createElement('tr');
                                    tr.innerHTML = "<tr><td class='each_td1'>" + arr[ar][1] + "</td>" + "<td class='each_td2'>" + "已改为" + "</td>" + "<td class='each_td3'>" + arr[ar][2] + "</td><td class='each_td4'></td></tr>";
                                    tbody.appendChild(tr);
    ...
    <div class="layui-layout layui-layout-admin">
        ...
        <div class="layui-header" style="background: rgb(19,29,47); opacity: 1">
            ...
            <ul class="layui-nav layui-layout-left">
                ...
                <li class="layui-nav-item layui-this"><a href="../jsp/new_sec_page.jsp">文档纠错</a></li>
...
<div class="left_box">
    <div class="btn_div">
        <div class="btns_box">
                        <div class="btn1">
                            <div class="file">
                                <%--                <button id="submit1" type="button" class="layui-btn layui-btn-radius layui-btn-normal" >上传文件</button>--%>
                                <input type="file" id="file" onchange="handleFiles(this.files)"class="layui-btn-radius" name="file">上传txt文件
                            </div>
                        </div>
...
<%--            </div>--%>
<%--            <div class="btn1">--%>
<%--                <button id="submit2" type="button" class="layui-btn layui-btn-radius" >下载文件</button>--%>
<%--            </div>--%>
            <div class="btn1">
<%--                <a href="/LRt1/DownloadServlet" id="download_link">下载文件</a>--%>
                <button id="submit4" type="button" class="layui-btn layui-btn-radius" ><a href="/LRt1/DownloadServlet" id="download_link">下载文件</a></button>
            </div>
<%--            <div class="btn1">--%>
<%--                &lt;%&ndash;                <a href="/LRt1/DownloadServlet" id="download_link">下载文件</a>&ndash;%&gt;--%>
<%--                <button id="submit5" type="button" class="layui-btn layui-btn-radius" >下载文件</button>--%>
<%--            </div>--%>
            <div class="btn1">
...
<%--    <img src="../images/rightImg.jpg" alt="" id="img_right">--%>
    ...
    <table id="table1id" cellspacing="0" border="0" style="border-collapse: separate;border-spacing: 0px 12px;" >
        ...
        <tr style="width: 100%;height: 10px">
            <th style="height: 10px;width: 10%"></th>
            <th style="height: 10px;width: 20%;"></th>
            <th style="height: 10px;width: 10%;"></th>
            <th style="height: 10px;width: 40%;"></th>
        </tr>
        </thead>
        <tbody id="tbody1">
        </tbody>
